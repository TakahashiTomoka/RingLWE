...
#efile = r"C:\scripts\sage\samples\Y_e_samples_p13_d503_q53_f4_r5.csv"
#afile = r"C:\scripts\sage\samples\Y_a_samples_p13_d503_q53_f4_r5.csv"
#arandomfile = r"C:\scripts\sage\samples\Y_a_random_samples_p13_d503_q53_f4_r5.csv"
#sfile = r"C:\scripts\sage\samples\Y_s_samples_p13_d503_q53_f4_r5.csv"
...
#np.savetxt('Y_e_samples_p{}_d{}_q{}_f{}_r{}.csv'.format(p,d,q,f,r0), ecoeffs, delimiter =",",fmt ='% s')
...
#np.savetxt('Y_a_samples_p{}_d{}_q{}_f{}_r{}.csv'.format(p,d,q,f,r0), acoeffs, delimiter =",",fmt ='% s')
#np.savetxt('Y_a_random_samples_p{}_d{}_q{}_f{}_r{}.csv'.format(p,d,q,f,r0), acoeffs_random, delimiter =",",fmt ='% s')
...
#np.savetxt('Y_s_samples_p{}_d{}_q{}_f{}_r{}.csv'.format(p,d,q,f,r0), scoeffs, delimiter =",",fmt ='% s')
...
for fac in fact:
    ...
    Frob_aa = [frob(aa) -aa for aa in amodqlst]
    Frob_bb = [frob(bb)-bb for bb in bmodqlst]
